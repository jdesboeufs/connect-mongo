...
module.exports = function(connect) {
  ...
  function MongoStore(options) {
    ...
    function initWithUrl() {
      ...
      console.log('global.mongoCert >>>>>> ', global.mongoCert);

      if (global.db) {
        self.db = db;
        connectionReady(null);
      } else {
        MongoClient.connect(process.env.MONGO_CONNECTION, { sslCA: global.mongoCert }, function(err, db) {
