...
module.exports = function (connect) {
  ...
  class MongoStore extends Store {
    ...
    set(sid, session, callback) {
      ...
      return withCallback(this.collectionReady()
        .then(collection => collection.updateMany({_id: this.computeStorageId(sid)}, s, {upsert: true}))
        .then(rawResponse => {
    ...
    touch(sid, session, callback) {
      ...
      return withCallback(this.collectionReady()
        .then(collection => collection.updateMany({_id: this.computeStorageId(sid)}, {$set: updateFields}))
        .then(result => {
